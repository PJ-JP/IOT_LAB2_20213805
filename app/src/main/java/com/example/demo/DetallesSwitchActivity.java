...
public class DetallesSwitchActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.save) {
            ...
            if(marca.equals("")||modelo.equals("")||velocidad.equals("")||tipo.equals("")||estado.equals("")){
                Toast.makeText(this, "Rellena todos los campos", Toast.LENGTH_SHORT).show();
                return false;
            } else {
                Switch switche = new Switch(marca, modelo, velocidad, tipo, estado);
                listaSwitches.set(posicion, switche);
